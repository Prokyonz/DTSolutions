USE [diamondtrading]
GO
/****** Object:  UserDefinedFunction [dbo].[CSVToTable]    Script Date: 26-02-2024 08:13:58 PM ******/
SET ANSI_NULLS ON
GO
...
END
GO
/****** Object:  UserDefinedFunction [dbo].[GetTransferFromDetails]    Script Date: 26-02-2024 08:13:59 PM ******/
SET ANSI_NULLS ON
GO
SET QUOTED_IDENTIFIER ON
GO
...
GO
/****** Object:  UserDefinedFunction [dbo].[GetKapanSaleDetail]    Script Date: 26-02-2024 08:13:59 PM ******/
SET ANSI_NULLS ON
GO
SET QUOTED_IDENTIFIER ON
GO
...
GO
/****** Object:  UserDefinedFunction [dbo].[GetKapanPurchaseExpenseDetail]    Script Date: 26-02-2024 08:13:59 PM ******/
SET ANSI_NULLS ON
GO
SET QUOTED_IDENTIFIER ON
GO
...
GO
/****** Object:  UserDefinedFunction [dbo].[GetAssortmentReceiveDetails]    Script Date: 26-02-2024 08:13:59 PM ******/
SET ANSI_NULLS ON
GO
SET QUOTED_IDENTIFIER ON
GO
...
GO
/****** Object:  UserDefinedFunction [dbo].[GetKapanOpeningBalance]    Script Date: 26-02-2024 08:13:59 PM ******/
SET ANSI_NULLS ON
GO
SET QUOTED_IDENTIFIER ON
GO
...
GO
/****** Object:  UserDefinedFunction [dbo].[GetKapanPurchaseDetails]    Script Date: 26-02-2024 08:13:59 PM ******/
SET ANSI_NULLS ON
GO
SET QUOTED_IDENTIFIER ON
GO
...
(SELECT 1 as Id,CAST(PM.Date as date) Date, PM.SlipNo,'' as OperationType,'' as Size,                      
 PAM.Name AS Party, PD.NetWeight as NetWeight,PD.BuyingRate as 'Rate', PM.GrossTotal as Amount,'Inward' as Category, 1 as CategoryId,1 as Records,      
 ...
 --group by PM.Date,PM.SlipNo,PAM.Name,PM.GrossTotal,KM.KapanId,km.BranchId) 
GO
/****** Object:  UserDefinedFunction [dbo].[GetTransferToDetails]    Script Date: 26-02-2024 08:13:59 PM ******/
SET ANSI_NULLS ON
GO
SET QUOTED_IDENTIFIER ON
GO
...
GO
/****** Object:  UserDefinedFunction [dbo].[GetKapanLagadDetails]    Script Date: 26-02-2024 08:13:59 PM ******/
SET ANSI_NULLS ON
GO
SET QUOTED_IDENTIFIER ON
GO
...
GO
/****** Object:  UserDefinedFunction [dbo].[GetRejectionOutDetail]    Script Date: 26-02-2024 08:13:59 PM ******/
SET ANSI_NULLS ON
GO
SET QUOTED_IDENTIFIER ON
GO
...
GO
/****** Object:  StoredProcedure [dbo].[CheckIsKapanMapEntryProcessed]    Script Date: 26-02-2024 08:13:59 PM ******/
SET ANSI_NULLS ON
GO
SET QUOTED_IDENTIFIER ON
GO
...
GO
/****** Object:  StoredProcedure [dbo].[GetAllKapanLagadDetails]    Script Date: 26-02-2024 08:13:59 PM ******/
SET ANSI_NULLS ON
GO
SET QUOTED_IDENTIFIER ON
GO
...
order by k1.Name        
GO
/****** Object:  StoredProcedure [dbo].[GetAllNumberStockDetails]    Script Date: 26-02-2024 08:13:59 PM ******/
SET ANSI_NULLS ON
GO
SET QUOTED_IDENTIFIER ON
GO
...
GO
/****** Object:  StoredProcedure [dbo].[GetAllNumberStockDetails_New]    Script Date: 26-02-2024 08:13:59 PM ******/
SET ANSI_NULLS ON
GO
SET QUOTED_IDENTIFIER ON
GO
...
left join PartyMaster pm ON pm.Id = sm.PartyId        
 ...
 order by n1.BranchName,n1.Size,n1.Number    
GO
/****** Object:  StoredProcedure [dbo].[GetAssortProcessKapanDetails]    Script Date: 26-02-2024 08:13:59 PM ******/
SET ANSI_NULLS ON
GO
SET QUOTED_IDENTIFIER ON
GO
...
GO
/****** Object:  StoredProcedure [dbo].[GetAssortProcessSendToDetail]    Script Date: 26-02-2024 08:13:59 PM ******/
SET ANSI_NULLS ON
GO
SET QUOTED_IDENTIFIER ON
GO
...
GO
/****** Object:  StoredProcedure [dbo].[GetAssortReceiveReport]    Script Date: 26-02-2024 08:13:59 PM ******/
SET ANSI_NULLS ON
GO
SET QUOTED_IDENTIFIER ON
GO
...
END
GO
/****** Object:  StoredProcedure [dbo].[GetAssortSendReport]    Script Date: 26-02-2024 08:13:59 PM ******/
SET ANSI_NULLS ON
GO
SET QUOTED_IDENTIFIER ON
GO
...
END
GO
/****** Object:  StoredProcedure [dbo].[GetAvailableSlipDetail]    Script Date: 26-02-2024 08:13:59 PM ******/
SET ANSI_NULLS ON
GO
SET QUOTED_IDENTIFIER ON
GO
...
End
GO
/****** Object:  StoredProcedure [dbo].[GetAvailableSlipsDetail]    Script Date: 26-02-2024 08:13:59 PM ******/
SET ANSI_NULLS ON
GO
SET QUOTED_IDENTIFIER ON
GO
...
End
GO
/****** Object:  StoredProcedure [dbo].[GetBalanceSheet]    Script Date: 26-02-2024 08:13:59 PM ******/
SET ANSI_NULLS ON
GO
SET QUOTED_IDENTIFIER ON
GO
...
BEGIN
	...
	-- INCLUDE THE OPENING BALANCE WITH LOAN ENTRY
		...
		SELECT T.ColType, T.Type, SUM(T.Balance) 'Amount' FROM (
				select 'Debit' 'ColType', 'Loan' 'Type', LBM.Balance from LedgerBalanceManager LBM INNER JOIN PartyMaster PM ON PM.Id = LBM.LedgerId
...
BEGIN
	...
	UNION ALL
		...
		select 'Debit' 'ColType', 'Loan' 'Type', SUM(LBM.Balance) 'Amount' from LedgerBalanceManager LBM INNER JOIN PartyMaster PM ON PM.Id = LBM.LedgerId
...
END
GO
/****** Object:  StoredProcedure [dbo].[GetBoilProcessReceiveDetail]    Script Date: 26-02-2024 08:13:59 PM ******/
SET ANSI_NULLS ON
GO
SET QUOTED_IDENTIFIER ON
GO
...
GO
/****** Object:  StoredProcedure [dbo].[GetBoilProcessSendToDetail]    Script Date: 26-02-2024 08:13:59 PM ******/
SET ANSI_NULLS ON
GO
SET QUOTED_IDENTIFIER ON
GO
...
GO
/****** Object:  StoredProcedure [dbo].[GetBoilSendReceiveReport]    Script Date: 26-02-2024 08:13:59 PM ******/
SET ANSI_NULLS ON
GO
SET QUOTED_IDENTIFIER ON
GO
...
END
GO
/****** Object:  StoredProcedure [dbo].[GetCalulatorDetails]    Script Date: 26-02-2024 08:13:59 PM ******/
SET ANSI_NULLS ON
GO
SET QUOTED_IDENTIFIER ON
GO
...
GO
/****** Object:  StoredProcedure [dbo].[GetCashBankReport]    Script Date: 26-02-2024 08:13:59 PM ******/
SET ANSI_NULLS ON
GO
SET QUOTED_IDENTIFIER ON
GO
...
END
GO
/****** Object:  StoredProcedure [dbo].[GetCharniDetailsForSales]    Script Date: 26-02-2024 08:13:59 PM ******/
SET ANSI_NULLS ON
GO
SET QUOTED_IDENTIFIER ON
GO
...
GO
/****** Object:  StoredProcedure [dbo].[GetCharniProcessReceiveDetail]    Script Date: 26-02-2024 08:13:59 PM ******/
SET ANSI_NULLS ON
GO
SET QUOTED_IDENTIFIER ON
GO
...
GO
/****** Object:  StoredProcedure [dbo].[GetCharniSendReceiveReport]    Script Date: 26-02-2024 08:13:59 PM ******/
SET ANSI_NULLS ON
GO
SET QUOTED_IDENTIFIER ON
GO
...
END
GO
/****** Object:  StoredProcedure [dbo].[GetCharniToDetail]    Script Date: 26-02-2024 08:13:59 PM ******/
SET ANSI_NULLS ON
GO
SET QUOTED_IDENTIFIER ON
GO
...
where AvailableWeight<>0 
GO
/****** Object:  StoredProcedure [dbo].[GetChildPurchaseReport]    Script Date: 26-02-2024 08:13:59 PM ******/
SET ANSI_NULLS ON
GO
SET QUOTED_IDENTIFIER ON
GO
...
GO
/****** Object:  StoredProcedure [dbo].[GetChildSalesReport]    Script Date: 26-02-2024 08:13:59 PM ******/
SET ANSI_NULLS ON
GO
SET QUOTED_IDENTIFIER ON
GO
...
GO
/****** Object:  StoredProcedure [dbo].[GetContraReport]    Script Date: 26-02-2024 08:13:59 PM ******/
SET ANSI_NULLS ON
GO
SET QUOTED_IDENTIFIER ON
GO
...
END
GO
/****** Object:  StoredProcedure [dbo].[GetDefaultSizeNumberDetailsForPriceMaster]    Script Date: 26-02-2024 08:13:59 PM ******/
SET ANSI_NULLS ON
GO
SET QUOTED_IDENTIFIER ON
GO
...
GO
/****** Object:  StoredProcedure [dbo].[GetExpenseReport]    Script Date: 26-02-2024 08:13:59 PM ******/
SET ANSI_NULLS ON
GO
SET QUOTED_IDENTIFIER ON
GO
...
END
GO
/****** Object:  StoredProcedure [dbo].[GetGalaProcessReceiveDetail]    Script Date: 26-02-2024 08:13:59 PM ******/
SET ANSI_NULLS ON
GO
SET QUOTED_IDENTIFIER ON
GO
...
where AvailableWeight<>0 
GO
/****** Object:  StoredProcedure [dbo].[GetGalaProcessSendToDetail]    Script Date: 26-02-2024 08:13:59 PM ******/
SET ANSI_NULLS ON
GO
SET QUOTED_IDENTIFIER ON
GO
...
where AvailableWeight<>0   
GO
/****** Object:  StoredProcedure [dbo].[GetGalaSendReceiveReport]    Script Date: 26-02-2024 08:13:59 PM ******/
SET ANSI_NULLS ON
GO
SET QUOTED_IDENTIFIER ON
GO
...
END
GO
/****** Object:  StoredProcedure [dbo].[GetJangadPrintDetails]    Script Date: 26-02-2024 08:13:59 PM ******/
SET ANSI_NULLS ON
GO
SET QUOTED_IDENTIFIER ON
GO
...
GO
/****** Object:  StoredProcedure [dbo].[GetJangadReceiveDetail]    Script Date: 26-02-2024 08:13:59 PM ******/
SET ANSI_NULLS ON
GO
SET QUOTED_IDENTIFIER ON
GO
...
GO
/****** Object:  StoredProcedure [dbo].[GetJangadReport]    Script Date: 26-02-2024 08:13:59 PM ******/
SET ANSI_NULLS ON
GO
SET QUOTED_IDENTIFIER ON
GO
...
END
GO
/****** Object:  StoredProcedure [dbo].[GetKapanLagadReportDetails]    Script Date: 26-02-2024 08:13:59 PM ******/
SET ANSI_NULLS ON
GO
SET QUOTED_IDENTIFIER ON
GO
--Exec GetKapanLagadReportDetails 'e711c76e-7789-4fd3-ac08-272dd94aaa65'
CREATE proc [dbo].[GetKapanLagadReportDetails] --'e711c76e-7789-4fd3-ac08-272dd94aaa65' --'6db63529-93ba-47d7-a96d-36492ec1fd56'--'2010ff7c-ddba-4a68-bf90-cc71bddb5852'--'ad852c84-ce9d-48ed-a5e4-e9bdce16da59'                  
...
as                    
 ...
 --group by PM.Date,PM.SlipNo,PAM.Name,PM.GrossTotal      
  SELECT 1 as Id,CAST(PM.Date as date) Date, PM.SlipNo,'' as OperationType,'' as Size,                    
 PAM.Name AS Party, PD.NetWeight as NetWeight,PD.BuyingRate as 'Rate', PD.NetWeight*PD.BuyingRate as Amount,'Inward' as Category, 1 as CategoryId,1 as Records    
 FROM KapanMappingMaster KM                    
 Left JOIN [PurchaseMaster] AS PM ON PM.Id=KM.PurchaseMasterId                    
 Left JOIN [PurchaseDetails] AS PD ON PD.Id=KM.PurchaseDetailsId AND PM.Id = PD.PurchaseId                        
 Left JOIN [PartyMaster] AS PAM ON PAM.Id = PM.PartyId                     
...
GO
/****** Object:  StoredProcedure [dbo].[GetKapanReport]    Script Date: 26-02-2024 08:13:59 PM ******/
SET ANSI_NULLS ON
GO
SET QUOTED_IDENTIFIER ON
GO
...
END 
GO
/****** Object:  StoredProcedure [dbo].[GetLedgerBalanceReport]    Script Date: 26-02-2024 08:13:59 PM ******/
SET ANSI_NULLS ON
GO
SET QUOTED_IDENTIFIER ON
GO
CREATE proc [dbo].[GetLedgerBalanceReport] --'62f594c4-c203-4b69-8424-ecc741e41e90', '146c24c5-6663-4f3d-bdfd-80469275c898'  
...
BEGIN  
  ...
  --where LBM.Ledgerid='811996d5-95ab-4324-8877-63469a6ec002'  
  Order By PM.Name ASC  
  
END  
  
GO
/****** Object:  StoredProcedure [dbo].[GetLedgerChildReport]    Script Date: 26-02-2024 08:13:59 PM ******/
SET ANSI_NULLS ON
GO
SET QUOTED_IDENTIFIER ON
GO
...
SELECT 'OpeningBalance' 'EntryType', '' 'FromPartyId', '' 'FromPartyName', '' 'ToPartyId', '' 'ToPartyName', '' 'SlipNo', 0 'Debit', Balance 'Credit', CAST(CreatedDate as Date) 'Date', '' Remarks From LedgerBalanceManager            
...
SELECT * FROM (            
 ...
 FROM (            
   ...
   inner join paymentmaster p on g.id = p.groupid             
   INNER join paymentdetails pd on pd.groupid = g.id and pd.PaymentId=p.Id       
   WHERE g.crdrtype=0 AND g.IsDelete = 0 AND g.FinancialYearId = @FinancialYearId AND g.CompanyId = @CompanyId            
...
END 
GO
/****** Object:  StoredProcedure [dbo].[GetLoanReport]    Script Date: 26-02-2024 08:13:59 PM ******/
SET ANSI_NULLS ON
GO
SET QUOTED_IDENTIFIER ON
GO
...
GO
/****** Object:  StoredProcedure [dbo].[GetMixedRepot]    Script Date: 26-02-2024 08:13:59 PM ******/
SET ANSI_NULLS ON
GO
SET QUOTED_IDENTIFIER ON
GO
...
BEGIN
    ...
    select * from(
			...
			case WHEN M.CrDrType = 1 then 'Receipt' END as TrType, M.Remarks FROM 
				...
				WHERE CrDrType = 1 AND G.IsDelete=0
			...
			case when M.CrDrType = 0 then 'Payment' END as TrType, M.Remarks  FROM 
				...
				FROM [PaymentMaster] as P INNER JOIN GroupPaymentMaster as G ON P.GroupId = G.Id
				INNER JOIN [PartyMaster] AS PM ON PM.Id = P.FromPartyId 
				WHERE CrDrType = 0 and G.IsDelete=0
				AND (CAST(G.EntryDate as Date) >= @FromDate AND CAST(G.EntryDate as Date) <= @ToDate)) AS M
			INNER JOIN [PartyMaster] AS PM1 ON PM1.Id = M.ToPartyId
			union
...
END
GO
/****** Object:  StoredProcedure [dbo].[GetNumberProcessReceiveDetail]    Script Date: 26-02-2024 08:13:59 PM ******/
SET ANSI_NULLS ON
GO
SET QUOTED_IDENTIFIER ON
GO
...
where AvailableWeight<>0 
GO
/****** Object:  StoredProcedure [dbo].[GetNumberProcessReturnDetail]    Script Date: 26-02-2024 08:13:59 PM ******/
SET ANSI_NULLS ON
GO
SET QUOTED_IDENTIFIER ON
GO
...
where AvailableWeight<>0 
GO
/****** Object:  StoredProcedure [dbo].[GetNumberProcessSendToDetail]    Script Date: 26-02-2024 08:13:59 PM ******/
SET ANSI_NULLS ON
GO
SET QUOTED_IDENTIFIER ON
GO
...
where AvailableWeight<>0     
GO
/****** Object:  StoredProcedure [dbo].[GetNumberProcessSendToDetail_bk_20220308]    Script Date: 26-02-2024 08:13:59 PM ******/
SET ANSI_NULLS ON
GO
SET QUOTED_IDENTIFIER ON
GO
...
GO
/****** Object:  StoredProcedure [dbo].[GetNumberSendReceiveReport]    Script Date: 26-02-2024 08:13:59 PM ******/
SET ANSI_NULLS ON
GO
SET QUOTED_IDENTIFIER ON
GO
...
END
GO
/****** Object:  StoredProcedure [dbo].[GetOpeningStockReport]    Script Date: 26-02-2024 08:13:59 PM ******/
SET ANSI_NULLS ON
GO
SET QUOTED_IDENTIFIER ON
GO
...
END
GO
/****** Object:  StoredProcedure [dbo].[getPaymentReport]    Script Date: 26-02-2024 08:13:59 PM ******/
SET ANSI_NULLS ON
GO
SET QUOTED_IDENTIFIER ON
GO
...
END 
GO
/****** Object:  StoredProcedure [dbo].[GetPendingKapanMapping]    Script Date: 26-02-2024 08:13:59 PM ******/
SET ANSI_NULLS ON
GO
SET QUOTED_IDENTIFIER ON
GO
...
END   
GO
/****** Object:  StoredProcedure [dbo].[GetPFReport]    Script Date: 26-02-2024 08:13:59 PM ******/
SET ANSI_NULLS ON
GO
SET QUOTED_IDENTIFIER ON
GO
...
END
GO
/****** Object:  StoredProcedure [dbo].[GetProfitAndLoss]    Script Date: 26-02-2024 08:13:59 PM ******/
SET ANSI_NULLS ON
GO
SET QUOTED_IDENTIFIER ON
GO
...
END
GO
/****** Object:  StoredProcedure [dbo].[GetPSSlipDetailsForPayment]    Script Date: 26-02-2024 08:13:59 PM ******/
SET ANSI_NULLS ON
GO
SET QUOTED_IDENTIFIER ON
GO
...
End 
GO
/****** Object:  StoredProcedure [dbo].[GetPurchaseDetailsForEdit]    Script Date: 26-02-2024 08:13:59 PM ******/
SET ANSI_NULLS ON
GO
SET QUOTED_IDENTIFIER ON
GO
...
GO
/****** Object:  StoredProcedure [dbo].[GetPurchaseReport]    Script Date: 26-02-2024 08:13:59 PM ******/
SET ANSI_NULLS ON
GO
SET QUOTED_IDENTIFIER ON
GO
...
END 
GO
/****** Object:  StoredProcedure [dbo].[GetPurchaseSlipDetail]    Script Date: 26-02-2024 08:13:59 PM ******/
SET ANSI_NULLS ON
GO
SET QUOTED_IDENTIFIER ON
GO
...
GO
/****** Object:  StoredProcedure [dbo].[GetPurchaseSlipPrintList]    Script Date: 26-02-2024 08:13:59 PM ******/
SET ANSI_NULLS ON
GO
SET QUOTED_IDENTIFIER ON
GO
...
order by pm.SlipNo
GO
/****** Object:  StoredProcedure [dbo].[GetReceivablePayableReport]    Script Date: 26-02-2024 08:13:59 PM ******/
SET ANSI_NULLS ON
GO
SET QUOTED_IDENTIFIER ON
GO
...
--, ReceiptFrom decimal(18,2), ReceiptTo decimal(18,2), ClosingBalance decimal(18,2))        
  ...
  SELECT * FROM (      
   ...
   SELECT LOWER(NEWID()) 'Id', T.Type, T.PartyId, T.Name, (Total - (CASE WHEN Amount IS NULL THEN 0 ELSE Amount END)) 'Total', EntryDate, T.SlipNo, BrokerName FROM (      
  ...
  GROUP BY PartyId, PM.Name, SlipNo, Date, PM1.Name) T        
  ...
  ON T.PartyId = M.PartyId AND T.SlipNo = M.SlipNo    
   ...
   WHERE PartyType = 10 AND ClosingBalance < 0 AND ClosingBalance <> 0)T        
            
  Order By SlipNo ASC        
 END           
END
GO
/****** Object:  StoredProcedure [dbo].[GetRejectInOutReport]    Script Date: 26-02-2024 08:13:59 PM ******/
SET ANSI_NULLS ON
GO
SET QUOTED_IDENTIFIER ON
GO
...
END
GO
/****** Object:  StoredProcedure [dbo].[GetRejectionSendReceiveDetail]    Script Date: 26-02-2024 08:13:59 PM ******/
SET ANSI_NULLS ON
GO
SET QUOTED_IDENTIFIER ON
GO
...
GO
/****** Object:  StoredProcedure [dbo].[GetSalaryReport]    Script Date: 26-02-2024 08:13:59 PM ******/
SET ANSI_NULLS ON
GO
SET QUOTED_IDENTIFIER ON
GO
...
END
GO
/****** Object:  StoredProcedure [dbo].[GetSalesItemDetails]    Script Date: 26-02-2024 08:13:59 PM ******/
SET ANSI_NULLS ON
GO
SET QUOTED_IDENTIFIER ON
GO
...
End   
GO
/****** Object:  StoredProcedure [dbo].[GetSalesReport]    Script Date: 26-02-2024 08:13:59 PM ******/
SET ANSI_NULLS ON
GO
SET QUOTED_IDENTIFIER ON
GO
...
IF @ActionType = 0           
 ...
 SELECT SM.Id, BM.Name 'BranchName', SM.CompanyId, SM.FinancialYearId,         
 (case when SD.Category=1 then ISNULL(KM.Name,'') else ISNULL(N.Name,'') end) 'KapanName', SM.SaleBillNo,         
 SM.SlipNo, CAST(SM.Date as date) Date, SM.Time, SM.PartyId, PAM.Name AS PartyName, PAM.MobileNo,         
 SM.SalerId as SalerId, PAM1.Name AS SalerName, PAM1.MobileNo AS SalerMobileNo,           
 SM.BrokerageId, PAM2.Name AS BrokerName, PAM2.MobileNo AS BrokerMobileNo,           
 SM.Total, SD.Amount 'GrossTotal', SM.DueDays,SM.DueDate, SM.PaymentDays, SM.PaymentDueDate, SM.IsPF, SM.IsSlip,           
 SM.UpdatedDate, SM.UpdatedBy, '' 'KapanId', SUM(SD.Weight) Weight, SD.SaleRate SaleRate, SM.Remarks, SM.Message,           
 SUM(ROUND(SD.CVDAmount,0)) 'CVDAmount', SUM(SD.LessDiscountPercentage) 'LessWeight', SD.NetWeight NetWeight, SM.RoundUpAmount,          
convert(varchar, SM.ApprovalType)'ApprovalType'              
 ...
 GROUP BY          
 SM.Id, SM.CompanyId, SM.FinancialYearId, SM.SaleBillNo, SM.SlipNo, SM.Date, SM.Time, SM.PartyId, PAM.Name, PAM.MobileNo, SM.SalerId, PAM1.Name, PAM1.MobileNo,           
 ...
 SM.RoundUpAmount, SM.ApprovalType, BM.Name, KM.Name, N.Name, SD.Category 
 order by SM.Date,SM.Time,SM.SlipNo desc       
...
END 
GO
/****** Object:  StoredProcedure [dbo].[GetSalesSlipDetail]    Script Date: 26-02-2024 08:13:59 PM ******/
SET ANSI_NULLS ON
GO
SET QUOTED_IDENTIFIER ON
GO
...
GO
/****** Object:  StoredProcedure [dbo].[GetSlipDetail]    Script Date: 26-02-2024 08:13:59 PM ******/
SET ANSI_NULLS ON
GO
SET QUOTED_IDENTIFIER ON
GO
...
End
GO
/****** Object:  StoredProcedure [dbo].[GetStockReport]    Script Date: 26-02-2024 08:13:59 PM ******/
SET ANSI_NULLS ON
GO
SET QUOTED_IDENTIFIER ON
GO
...
END
GO
/****** Object:  StoredProcedure [dbo].[GetTransferCategoryList]    Script Date: 26-02-2024 08:13:59 PM ******/
SET ANSI_NULLS ON
GO
SET QUOTED_IDENTIFIER ON
GO
...
order by Category
GO
/****** Object:  StoredProcedure [dbo].[GetTypeDetails]    Script Date: 26-02-2024 08:13:59 PM ******/
SET ANSI_NULLS ON
GO
SET QUOTED_IDENTIFIER ON
GO
...
GO
/****** Object:  StoredProcedure [dbo].[GetWeeklyPurchaseReport]    Script Date: 26-02-2024 08:13:59 PM ******/
SET ANSI_NULLS ON
GO
SET QUOTED_IDENTIFIER ON
GO
...
BEGIN    
 ...
 END
GO
/****** Object:  StoredProcedure [dbo].[Validate_Records]    Script Date: 26-02-2024 08:13:59 PM ******/
SET ANSI_NULLS ON
GO
SET QUOTED_IDENTIFIER ON
GO
